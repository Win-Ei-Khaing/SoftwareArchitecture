...
public class MathControllerIntegrationTest {
	...
	@Test
	public void given_WhenAdd1and3_ThenReturn4() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/add?number1=1&number2=3")
						.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
	...
	@Test
	public void given_WhenDouble2_ThenReturn4() throws Exception {
